...
{
    public partial class ADXConnectionUIControl : DataConnectionUIControl
    {
        public ADXConnectionUIControl()
        {
            InitializeComponent();
        }
        ...
        public override void LoadProperties()
        {
            ...
            try
            {
                clusterTextBox.Text = (string)Site["Cluster"];
        ...
        void SetProperty(object sender, EventArgs e)
        {
            ...
            if (sender == clusterTextBox)
                Site["Cluster"] = clusterTextBox.Text.Trim();
