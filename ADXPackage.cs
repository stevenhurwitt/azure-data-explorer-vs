//------------------------------------------------------------------------------
// <copyright file="ADXPackage.cs" company="Company">
...
namespace AzureDataExplorer
{
    ...
    [ProvideService(typeof(ADXProviderObjectFactory), IsAsyncQueryable = true, ServiceName = "Kusto Provider Object Factory")]
    ...
    public sealed class ADXPackage : AsyncPackage
    {
        /// <summary>
        ...
        {
            AddService(typeof(ADXProviderObjectFactory), CreateServiceAsync, true);
        ...
        Task<object> CreateServiceAsync(IAsyncServiceContainer container, CancellationToken cancellationtoken, Type servicetype)
            => servicetype == typeof(ADXProviderObjectFactory)
                ? Task.FromResult<object>(new ADXProviderObjectFactory())
        ...
        void SetupNpgsqlProviderFactory()
        {
            ...
            else
            {
                ...
                if (factoriesTable.Rows.Find(Constants.ADXInvariantName) != null)
                {
            ...
            factoriesTable.Rows.Add("Kusto Data Provider", ".NET Data Provider for Kusto",
                Constants.ADXInvariantName, "ADX.ADXFactory, AzureDataExplorer");
        }
    }
}
